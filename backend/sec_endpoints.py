...
def export_exams_excel():
    ...
    try:
        ...
        with pd.ExcelWriter(output, engine='xlsxwriter') as writer:
            ...
            title_sheet.merge_range('A1:D1', 'FIESC Exam Schedule', title_format)
            title_sheet.write('A3', 'Export Date:', info_format)
            title_sheet.write('B3', datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S'), info_format)
            title_sheet.write('A4', 'Total Exams:', info_format)
            title_sheet.write('B4', len(df), info_format)
            title_sheet.write('A5', 'Generated By:', info_format)
            ...
            worksheet.merge_range('A1:K1', 'Confirmed Exams', title_format)
